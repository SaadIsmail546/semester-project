...
int slot_machine_winnings_reporter(int &final_balance, string file_name) {
    ...
    my_file << "\nYou played the slot machine, your balance changed to: $" << final_balance << endl;
    my_file.close();
...
void slot_machine_main(){
    ...
    do {
        cout<<"Enter your starting balance in $ (Maximum allowed: $50)"<<endl;
        cin>>balance;
    ...
    {
        cout<<"Main Menu"<<endl;
        cout<<"1. Spin slot machine ($5 per spin)"<<endl;
        cout<<"2. View balance"<<endl;
        cout<<"3. Exit game"<<endl;
        cout<<"What option would you like to perform?"<<endl;
        cin>>option;
        cout<<endl;
